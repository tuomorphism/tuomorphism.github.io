...
- **NEW**: notebook/markdown assets are also mirrored to `public/blog/<slug>/assets/`
- **NEW**: markdown/HTML URLs are rewritten to `/blog/<slug>/assets/...` so the browser finds them
"""
